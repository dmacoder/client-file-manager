...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private static final int TARGET_URL= 1;
    private static final int SESSION_URL= 2;
    private static final int REFERER_URL= 3;
    private static final int DEFAULT_URL= 0;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication auth) throws IOException, ServletException {
        ...
        logger.info("auth name : "+auth.getAuthorities().getClass().getName());
        
        List<GrantedAuthority> authorities = (List<GrantedAuthority>) auth.getAuthorities();
        String strAuth = authorities.get(0).getAuthority();
        logger.info("str auth : "+strAuth);
