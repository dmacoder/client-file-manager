 ...
 *   2019.06.20     박세창          getStringNumberWithComma 메소드 추가
 * 
 * </pre>
 */
...
/**
    ...
    public static String getStringNumberWithComma(String strValue,int decimalPointCnt) {
        ...
        if(decimalPointCnt>0) {
            formatStr = formatStr+".";
            for(int i=1 ; i<=decimalPointCnt;i++) {
                formatStr = formatStr+"#";
            }
        }
